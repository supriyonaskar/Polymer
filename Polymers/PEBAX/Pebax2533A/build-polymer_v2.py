...
if opt ==0:
    def monomer1(is_capped=True):
        ...
        lmps.quick_md(s,save_input=False)
    ...
    polymer_3 = random_walk(pe, 3, forcefield=forcefield.Gaff(),density = 0.001)
    exec('cap_with_H(polymer_3, forcefield.Gaff())')
    lmps.quick_min(polymer_3, min_style='fire')
    polymer_3.write_pdb("polymer_3.pdb")
    # In[169]:
