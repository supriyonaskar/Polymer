...
if opt ==1:
    ...
    #options = {'constraint_charge': [0.0, [5,6,8,23,24,27,28]]}
    #options = {'constraint_charge': [[0.0, [1,2,3,19,20,21,22]], [0.0, [5,6,8,23,24,27,28]], [0.0, [7,10,12,25,26,31,32]]]}
    options = {'constraint_charge': [[0.0, [11,16,17,18,29,30,36]], [0.0, [5,6,8,23,24,27,28]], [0.0, [4,13,9,15,35,14,33,34]]]}
